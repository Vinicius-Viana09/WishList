    ...
    public partial class WishListContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //optionsBuilder.UseSqlServer("Data Source=DESKTOP-RJD23R9\\SQLEXPRESS; initial catalog=WISHLIST_G4; user Id=sa; pwd=Senai@132;");
                optionsBuilder.UseSqlServer("Data Source=LAPTOP-7R4I65FT\\SQLEXPRESS; initial catalog=WISHLIST_G4; user Id=sa; pwd=SQLsenha123;");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Desejo>(entity =>
            {
                entity.HasKey(e => e.IdDesejo)
                    .HasName("PK__DESEJOS__5DB1341F8ADA6A9A");
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                entity.HasKey(e => e.IdUsuario)
                    .HasName("PK__USUARIOS__645723A6C115B725");
